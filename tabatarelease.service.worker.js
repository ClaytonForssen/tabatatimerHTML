...
/** @type {string} */
const CACHE_VERSION = '1746792632|1341340016';
/** @type {string} */
const CACHE_PREFIX = 'SWTQ-workoutHTML-sw-cache-';
...
/** @type {string[]} */
const CACHED_FILES = ["tabatarelease.html","tabatarelease.js","tabatarelease.offline.html","tabatarelease.icon.png","tabatarelease.apple-touch-icon.png","tabatarelease.audio.worklet.js","tabatarelease.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["tabatarelease.wasm","tabatarelease.pck"];
